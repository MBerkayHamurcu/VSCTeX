...
- **Edit your LaTeX files**: You can use VS Code to edit your LaTeX files as you normally would. The Dev Container will automatically import the `.tex` files in the `content` folder in the order they are listed in the file explorer. This is also true for the `appendix` folder. The built-in spell and grammar checker (LTeX) helps you correcting your mistakes.
