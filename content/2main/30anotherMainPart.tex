...
Vier Bilder vertikal und horizontal geteilt. Das Format der beiden Bilder zueinander ist relevant, die subfigure breiten müssen dementsprechend angepasst werden!:
\begin{figure}[H]
  \centering
...
\begin{longtblr}[
  ...
  vlines={black, 0.1pt},
  rowhead=1,
  row{1}={tableContrast,font=\bfseries}
  }
