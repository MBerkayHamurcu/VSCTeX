...
% Define new \Chapter macro for printing the correct title in the header
\newcommand{\Chapter}[2][UNDEFINED]{%
  \ifstrequal{#1}{UNDEFINED}{%
    \chapter{#2}
    \markboth{\thechapter. #2}{\thechapter. #2}
  }{%
    \chapter[#1]{#2}
...
% To-Do notes support
\usepackage[colorinlistoftodos,textsize=tiny,ngerman]{todonotes}
...
\g@addto@macro\listoflistedEquations{%
  % Add list of tables to the table of content
