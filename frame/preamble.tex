...
\NewTblrTheme{matchingCaptionNoContinuation}{
  \SetTblrStyle{caption-tag}{font=\small\bfseries}
  \SetTblrStyle{caption-text}{font=\small\mdseries}

  \DefTblrTemplate{middlehead,lasthead}{tblrContDisabled}{}
  \SetTblrTemplate{middlehead,lasthead}{tblrContDisabled}
  \DefTblrTemplate{firstfoot,middlefoot}{tblrContDisabled}{}
  \SetTblrTemplate{firstfoot,middlefoot}{tblrContDisabled}
}
